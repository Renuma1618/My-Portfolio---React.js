...
const Navbar = () => {
  ...
  return (
    <div className='navbar'>
        ...
        <img src= {menu_open}  onClick={openMenu}alt="" className='nav-open-menu'/>     
        <ul ref={menuRef}className='nav-menu'>
          <img src={menu_close} onClick={closeMenu} className='nav-mob-close '/>
           ...
           <li><AnchorLink  className='anchor-link' offset={50} href='#work'><p onClick={()=>setMenu("work")}>My Work</p></AnchorLink>{menu==="portfolio"?<img src={underline} alt=''/>:<></>}</li>
